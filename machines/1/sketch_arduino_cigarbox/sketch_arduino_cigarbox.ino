    ...
    if(end_of_line == 13 ){
         ...
         switch(channel){
             ...
             case 1:
                ...
                break; 
            case 2: 
                   setNeoPixel(2,finalvalue,0 ,0);
                break;
           case 3:
                   setNeoPixel(3, 0,finalvalue, 0);
              break;
             case 4:
                   setNeoPixel(4,0, 0,finalvalue);
                break; 
            case 5: 
                   setNeoPixel(5, finalvalue,0,0);
                break;
             case 6:
                   setNeoPixel(6,0,finalvalue,0);
              break;
             case 7:
                   setNeoPixel(7, 0,0,finalvalue);
                break; 
            case 8: 
                   setNeoPixel(8, finalvalue,0 ,0);
                break;
            case 9:
                   setNeoPixel(9, 0, finalvalue,0);
              break;
             case 10:
                   setNeoPixel(10, 0,0,finalvalue);
                break; 
            case 11: 
                   setNeoPixel(11,finalvalue,0,0);
                break;
            case 13:
